...
2. **Platform Version**: Currently targeting IntelliJ 262.8665.81-EAP-SNAPSHOT (2026.2 Beta, pinned dated build — bump gradle.properties `platformVersion`/`pluginSinceBuild` and uiTest Setup.kt `useEAP(...)` in lockstep)
