...
2. **Platform Version**: Currently targeting IntelliJ 262.8117.19-EAP-SNAPSHOT (pinned dated EAP build — bump gradle.properties `platformVersion`/`pluginSinceBuild` and uiTest Setup.kt `useEAP(...)` in lockstep)
