...
configurations.all {
    ...
    resolutionStrategy.force("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.9.0")
}
...
dependencies {
    ...
    implementation("com.fasterxml.jackson.module:jackson-module-kotlin:2.18.0") { isTransitive = false }
    ...
    uiTestRuntimeOnly("org.junit.jupiter:junit-jupiter-engine:5.11.2")
}
