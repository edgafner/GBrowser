...
dependencies { // IntelliJ Platform dependencies
  ...
  implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.19.0") { isTransitive = false }
  implementation("com.fasterxml.jackson.core:jackson-databind:2.19.0") { isTransitive = false }
  implementation("com.fasterxml.jackson.dataformat:jackson-dataformat-yaml:2.19.0") { isTransitive = false }
