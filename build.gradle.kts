...
configurations.all {
    resolutionStrategy.force("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.10.2")
    resolutionStrategy.force("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.10.2")
}
...
dependencies {
    ...
    uiTestImplementation("org.opentest4j:opentest4j:1.3.0")
    uiTestImplementation("org.junit.jupiter:junit-jupiter-api:5.12.1")
