...
dependencies { // IntelliJ Platform dependencies
  ...
  implementation("com.fasterxml.jackson.core:jackson-databind:2.20.0") { isTransitive = false }
  ...
  uiTestRuntimeOnly("org.junit.platform:junit-platform-launcher:6.0.0")
}
