...
import com.github.gib.uitl.namedChildScope
...
private class ReviewToolwindowTabsManager<T : GBrowserTab, TVM : GBrowserTabViewModel, PVM : GBrowserToolwindowProjectViewModel<T, TVM>>(
  ...
  private val REVIEW_TAB_KEY: Key<T> = Key.create("com.github.gib.ui.toolwindow.base.tab")

  @Suppress("PrivatePropertyName")
  private val REVIEW_TAB_VM_KEY: Key<TVM> = Key.create("com.github.gib.ui.toolwindow.base.tab.vm")
}
