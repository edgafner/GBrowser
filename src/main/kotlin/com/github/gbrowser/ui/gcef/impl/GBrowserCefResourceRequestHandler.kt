...
class GBrowserCefResourceRequestHandler(private val delegate: GBrowserCefRequestDelegate? = null) : CefResourceRequestHandlerAdapter() {
  ...
  override fun onBeforeResourceLoad(browser: CefBrowser?, frame: CefFrame?, request: CefRequest): Boolean {
    ...
    GBrowserSetting.instance().requestHeaders.forEach { header ->
  ...
  override fun onResourceLoadComplete(
    browser: CefBrowser?, frame: CefFrame?, request: CefRequest?, response: CefResponse?, status: Status?, receivedContentLength: Long
  ) {
  ...
  override fun onResourceResponse(
    browser: CefBrowser?, frame: CefFrame?, request: CefRequest?, response: CefResponse?
  ): Boolean {
