...
@State(name = "GBrowserService", storages = [Storage(value = "gbrowser_service.xml"), Storage(value = "gbrowser.xml", deprecated = true)],
...
class GBrowserService : SerializablePersistentStateComponent<GBrowserService.SettingsState>(SettingsState()) {
  ...
  @Serializable
  data class SettingsState(var defaultHomePage: String = "https://dorkag.com/dorkag",
