...
/**
 * Unit tests for GBrowserRefreshAction.
 *
 ...
 * - Actual browser instances with loaded content
 ...
 */
@DisplayName("GBrowserRefreshAction Tests")
class GBrowserRefreshActionTest {

  private lateinit var action: GBrowserRefreshAction

  @BeforeEach
  fun setUp() {
    action = GBrowserRefreshAction()
  }
