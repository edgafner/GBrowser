...
/**
 * Unit tests for GBrowserHomeAction.
 *
 ...
 * - Thread safety (EDT execution)
 * - Basic action properties
 * - DumbAware implementation
 */
@DisplayName("GBrowserHomeAction Tests")
class GBrowserHomeActionTest {

  private lateinit var action: GBrowserHomeAction

  @BeforeEach
  fun setUp() {
    action = GBrowserHomeAction()
  }
