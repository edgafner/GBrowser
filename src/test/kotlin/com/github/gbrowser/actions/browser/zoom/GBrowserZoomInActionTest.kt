...
/**
 * Unit tests for GBrowserZoomInAction.
 *
 ...
 */
@DisplayName("GBrowserZoomInAction Tests")
class GBrowserZoomInActionTest {

  private lateinit var action: GBrowserZoomInAction

  @BeforeEach
  fun setUp() {
    action = GBrowserZoomInAction()
  }
