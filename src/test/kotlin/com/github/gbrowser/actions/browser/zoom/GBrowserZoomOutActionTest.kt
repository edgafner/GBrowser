...
/**
 * Unit tests for GBrowserZoomOutAction.
 *
 ...
 */
@DisplayName("GBrowserZoomOutAction Tests")
class GBrowserZoomOutActionTest {

  private lateinit var action: GBrowserZoomOutAction

  @BeforeEach
  fun setUp() {
    action = GBrowserZoomOutAction()
  }
  ...
  fun `test action is thread safe and runs on BGT`() {
    // Zoom actions run on BGT to avoid blocking the UI thread
