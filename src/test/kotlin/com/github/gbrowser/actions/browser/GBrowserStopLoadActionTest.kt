...
/**
 * Unit tests for GBrowserStopLoadAction.
 *
 ...
 * - Actual browser instances loading content
 ...
 */
@DisplayName("GBrowserStopLoadAction Tests")
class GBrowserStopLoadActionTest {

  private lateinit var action: GBrowserStopLoadAction

  @BeforeEach
  fun setUp() {
    action = GBrowserStopLoadAction()
  }
