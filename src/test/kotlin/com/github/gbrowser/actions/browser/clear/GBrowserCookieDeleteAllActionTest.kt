...
/**
 * Unit tests for GBrowserCookieDeleteAllAction.
 *
 ...
 * - Actual browser instances with cookies
 * - Tool window system initialized
 * - UI testing framework
 *
 * The following aspects are tested:
 * - Action instantiation
 * - Thread safety (EDT execution for browser operations)
 * - Basic action properties
 * - DumbAware implementation
 */
@DisplayName("GBrowserCookieDeleteAllAction Tests")
class GBrowserCookieDeleteAllActionTest {

  private lateinit var action: GBrowserCookieDeleteAllAction

  @BeforeEach
  fun setUp() {
    action = GBrowserCookieDeleteAllAction()
  }
