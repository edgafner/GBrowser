...
/**
 * Unit tests for GBrowserTabDuplicateAction.
 *
 ...
 * - Browser panel with loaded content
 * - Content manager
 ...
 */
@DisplayName("GBrowserTabDuplicateAction Tests")
class GBrowserTabDuplicateActionTest {

  private lateinit var action: GBrowserTabDuplicateAction

  @BeforeEach
  fun setUp() {
    action = GBrowserTabDuplicateAction()
  }
